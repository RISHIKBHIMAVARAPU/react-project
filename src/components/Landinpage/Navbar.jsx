  ...
  return (
    ...
    <div className='flex justify-between items-center h-24 max-w-[1240px] mx-auto px-4 text-white'>
      ...
      <ul className='hidden md:flex'>
        <li className='p-4'><Link to="/signin" style={{color:'white',textDecoration:'none'}}> Login </Link></li>
        <li className='p-4'><Link to="/signup" style={{color:'white',textDecoration:'none'}} > Signup </Link></li>
        <li className='p-4'><Link to="/adlogin" style={{color:'white',textDecoration:'none'}} > Admin</Link></li>
        <li className='p-4'><Link to="/" style={{color:'white',textDecoration:'none'}} > About</Link></li>
        <li className='p-4'><Link to="/" style={{color:'white',textDecoration:'none'}} > Contact </Link></li>
      </ul>
